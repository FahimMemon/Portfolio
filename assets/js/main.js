...
$(document).ready(function() {
    ...
    $(".countdown")
        .countdown("2018/03/01", function(event) {
            $(this).html(
                event.strftime('<div>12 <span>Weeks</span></div>  <div>84 <span>Days</span></div>  <div>290<span>Hours</span></div> <div>1000<span>Minutes</span></div> <div>05<span>Seconds</span></div>')
            );
        });
